...
_, _, _, _, , , rule_logits, , , _ = model(obs_aug, num_aug, text_aug, audio_aug)
...
torch.nn.utils.clip_grad_norm(model.parameters(), max_norm=1.5)
...
ts_name = os.path.join(models_dir, f"policy{int(time.time())}.pt")

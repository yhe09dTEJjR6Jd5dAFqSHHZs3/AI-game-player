这是一个皇室战争AI，给出评价、建议，以及进一步完善后的完整代码的下载链接。
...
默认文件地址：
"D:\LDPlayer9\adb.exe"
"D:\LDPlayer9\dnplayer.exe"

脚本在运行过程中生成的所有文件，均位于Desktop\GameAI及其子文件夹（AI模型、经验池）。

流程：运行脚本→用户在安卓模拟器上玩几局皇室战争→用户按F8→AI玩皇室战争→用户按F8→AI停止玩皇室战争。

达到职业玩家水平，真正理解卡牌、等级、卡组、圣水、觉醒、英雄、血量等信息。
